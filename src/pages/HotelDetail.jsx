  ...
  return (
    <div className="md:container">
      ...
      <div>
        ...
        <img
          className="w-screen max-h-56"
          src="https://quickstay.vn/uploads/hotel_image/phpV62fSV.jpg"
          alt=""
        />
      </div>
            ...
            <div className="flex justify-end text-right">
              <div>
                <p className="font-bold text-gray-400 ">
                  2h Đầu
                  <span className="text-yellow-500">120.000đ</span>
                </p>
                <p className="font-bold text-gray-400 ">
                  Qua đêm
                  <span className="text-black">220.000đ</span>
                </p>
