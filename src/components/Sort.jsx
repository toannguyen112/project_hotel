...
function Sort({ closeTab }) {
    ...
    return (
        <div className="sort ">
            <div className="fixed top-0 bottom-0 left-0 right-0 bg-gray-900 opacity-20"  onClick={() => close()} ></div>
            <div className="  rounded-t-lg fixed bottom-0 w-full left-0 right-0  z-50 ">
